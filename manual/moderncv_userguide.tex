...
In order to use the \code{polyglossia} package it is necessary to create the file
\begin{lstlisting}
  cvloadbeforehyperref.tex 
\end{lstlisting}
in the same directory where your CV file lies and include 
loading \Code{polyglossia} and its configuration therein. Example
\begin{lstlisting}
  % file cvloadbeforehyperref.tex
